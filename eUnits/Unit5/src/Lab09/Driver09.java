...
public class Driver09 {
	...
	public static String convert(String website) {
		String packageName = "";
		int pos = website.lastIndexOf(".");
		packageName += website.substring(pos + 1, website.length());
		
		while(pos != 3) {
			int tempPos = website.lastIndexOf(".", pos-1);
			packageName += ".";
			packageName += website.substring(tempPos + 1, pos);
			pos = tempPos;
		}
