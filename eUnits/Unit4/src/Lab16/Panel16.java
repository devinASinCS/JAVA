...
public class Panel16 extends JPanel {
	...
	private class Listener implements ActionListener {
		public void actionPerformed(ActionEvent e) {
			if (gameover == true) {
				Clear();
			} else if (Gameboard.GameBoard[10 - turnnumber][0].getBackground() == Color.darkGray
					|| Gameboard.GameBoard[10 - turnnumber][1].getBackground() == Color.darkGray
					|| Gameboard.GameBoard[10 - turnnumber][2].getBackground() == Color.darkGray
					|| Gameboard.GameBoard[10 - turnnumber][3].getBackground() == Color.darkGray) {
				;
			} else if (answerboard.RightAnswer(Gameboard.returnAnswer(), Gameboard.returnGuess(10 - turnnumber))) {
				Gameboard.Freeze();
				scoreboard.victory();
				answerboard.returnResult(Gameboard.returnAnswer(), Gameboard.returnGuess(10 - turnnumber),
						10 - turnnumber);
				gameover = true;
			} else {
				answerboard.returnResult(Gameboard.returnAnswer(), Gameboard.returnGuess(10 - turnnumber),
